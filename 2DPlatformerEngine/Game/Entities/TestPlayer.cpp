...
namespace Game {
	...
	void Player::OnCreate() {
		...
		// load texture and pass it to the sprite
		Content::Texture2D texture = Content::ContentHandler::Load<Content::Texture2D>("testImage.png");
		sprite.SetTexture(texture);
		sprite.SetScale(vec2(0.1f, 0.1f));
	...
	void Player::Draw(const mat4& view, const mat4& proj) {
		// draw the sprite
		sprite.Draw(view, proj, GetPosition());
